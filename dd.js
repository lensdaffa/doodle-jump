...
// Platform kecil-kecil: lebar 45–60px, jarak rapat agar mudah dijangkau
function maxPlatGap() { return Math.floor((JUMP_FORCE * JUMP_FORCE) / (2 * GRAVITY) * 0.35); }
function platW()      { return 45 + Math.floor(Math.random() * 20); } // 45–64px
...
function update() {
  ...
  while (platforms.length < PLATFORM_COUNT + 2) {
